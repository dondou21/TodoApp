...
export namespace Prisma {
  ...
  */
  ...
  export type UserOmit<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetOmit<
    'id' | 'createdAt' | 'email' | 'name' | 'passwordHash',
    ExtArgs['result']['user']
  >;
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    todos<T extends User$todosArgs<ExtArgs> = {}>(
      args?: Subset<T, User$todosArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
  ...
  export type TodoOmit<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetOmit<
    'id' | 'createdAt' | 'name' | 'completed' | 'userId',
    ExtArgs['result']['todo']
  >;
  ...
  export type TodoCreateNestedManyWithoutUserInput = {
    create?:
      | XOR<TodoCreateWithoutUserInput, TodoUncheckedCreateWithoutUserInput>
  ...
  export type TodoUpdateManyWithWhereWithoutUserInput = {
    ...
    data: XOR<
      ...
      TodoUncheckedUpdateManyWithoutUserInput
    >;
  };
